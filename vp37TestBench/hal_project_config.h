 ...
 * @brief JaszczurHAL module configuration for the vp37TestBench project.
 *
...
/* ── Modules not used by vp37TestBench ──────────────────────────────────────── */
...
#define HAL_DISPLAY_ST7796S         /* ST7796S TFT driver                  */
#define HAL_DISABLE_SSD1306         /* SSD1306 OLED driver                 */
#define HAL_DISABLE_UNITY           /* Unity unit testing framework         */
#define HAL_DISABLE_RGB_LED         /* RGB LED control                      */
#define HAL_DISABLE_CAN             /* CAN bus support                      */
